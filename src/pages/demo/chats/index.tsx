    ...
    <Layout fixed>
      ...
      <Layout.Body className='sm:overflow-hidden'>
        <section className='flex h-full gap-6'>
          ...
          <div
            className={cn(
              'absolute inset-0 left-full z-50 flex w-full flex-1 flex-col rounded-md border bg-muted shadow-sm transition-all duration-200 sm:static sm:z-auto sm:flex',
